...
<table width="100%"  border="0">
  	<tr>
    <td class="H1"><%= strTXTEditSong  %> </td>
  	</tr>
  		<tr>
  			<td>
	<form action="Code_page/Edit_Song_code.asp" method="post" name="Edit" id="Edit">
	  <table width="100%"  border="0" class="border">

		 <tr>
          <td colspan="2"><input name="ID_Song" type="hidden" id="ID_Song" value="<%= objrs.fields.item("ID_Song").value %>"> 
          <input name="ID_artist" type="hidden"  id="ID_artist" value="<%= objrs.fields.item("ID_artist").value %>"></td>
        </tr>
        <tr>
          <td>
            
              <div align="left">
                <input name="name_Song" type="text" id="name_Song" value="<%= objrs.fields.item("name_Song").value %>">
        ...
        <tr>
          <td>
            <div align="left">
              <input name="link_128_Song" type="text" id="link_128_Song" value="<%= objrs.fields.item("link_128_Song").value %>">
            </div></td>
        ...
        <tr>
          <td>
            <div align="left">
              <input name="link_64_Song" type="text" id="link_64_Song" value="<%= objrs.fields.item("link_64_Song").value %>">
            </div></td>
        ...
        <tr>
          <td>
            <div align="left">
              <input name="size_Song" type="text" id="size_Song" value="<%= objrs.fields.item("size_Song").value %>">
            </div></td>
		...
		<td>
		  <div align="left">
		    <input name="time_Song" type="text" id="time_Song" value="<%= objrs.fields.item("time_Song").value %>">
		    </div></td>
        ...
        <tr>
          <td colspan="2">
			...
			&nbsp;&nbsp;
               ...
               <input name="Submit" type="reset" id="Submit" value="<%=strTXTRest%>">
