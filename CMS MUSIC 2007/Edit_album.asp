...
'Dim Profile Page
Dim int_ID_artist
set int_ID_artist =Request.QueryString("artistID")
...
<table width="100%"  border="0">
  	<tr>
    <td class="H1"><%= strTXTEditAlbum %></td>
  	</tr>
  		<tr>
  			<td>
	<form action="Code_page/Edit_album_code.asp" method="post" name="Edit" id="Edit">
	  <table width="100%"  border="0" class="border">

		 <tr>
          <td colspan="2"><input name="ID_album" type="hidden" id="ID_album" value="<%= objrs.fields.item("ID_album").value %>"> <input name="ID_artist" type="hidden" id="ID_artist" value="<%= response.Write(int_ID_artist) %>"></td>
        </tr>
        <tr>
          <td>
            
              <div align="left">
                <input name="name_album" type="text" id="name_album" value="<%= objrs.fields.item("name_album").value %>">
        ...
        <tr>
          <td>
            <div align="left">
              <input name="style_album" type="text" id="style_album" value="<%= objrs.fields.item("style_album").value %>">
            </div></td>
        ...
        <tr>
          <td>
            <div align="left">
              <input name="date_album" type="text" id="date_album" value="<%= objrs.fields.item("date_album").value %>">
            </div></td>
        ...
        <tr>
          <td>
            <div align="left">
              <input name="cover_front_album" type="text" id="cover_front_album" value="<%= objrs.fields.item("cover_front_album").value %>">
            </div></td>
		...
		<td>
		  <div align="left">
		    <input name="cover_back_album" type="text" id="cover_back_album" value="<%= objrs.fields.item("cover_back_album").value %>">
		    </div></td>
        ...
        <tr>
          <td colspan="2">
			...
			&nbsp;&nbsp;
               ...
               <input type="reset" name="Submit2" value="<%= strTXTRest%>">
