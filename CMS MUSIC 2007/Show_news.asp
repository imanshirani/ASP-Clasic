...
<tr>
    <td><span class="H1"><%= objRS.fields("Subject_News").value %></span></td>
  </tr>
  <tr>
    <td><span class="text3"><%= objRS.fields("Full_MSG_News").value %></span></td>
  </tr>
  <tr>
    <td><span class="text3"><%= objRS.fields("date_add_News").value %></span></td>
  </tr>
<% 
End if
objRS.Close()
