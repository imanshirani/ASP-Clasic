...
<table width="100%"  border="0">
  	<tr>
    <td class="H1"><%= strTXTEditArtist %></td>
  	</tr>
  		<tr>
  			<td>
	<form action="Code_page/Edit_artist_code.asp" method="post" name="Edit" id="Edit">
	  <table width="100%"  border="0" class="border">

		 <tr>
          <td colspan="2"><input name="ID_artist" type="hidden" id="ID_artist" value="<%= objrs.fields.item("ID_artist").value %>"><%= Response.Write(strER) %></td>
        </tr>
        <tr>
          <td>
            
              <div align="left">
                <input name="name_artist" type="text" id="name_artist" value="<%= objrs.fields.item("name_artist").value %>">
              
            </div></td>
          <td class="text3"><div align="right"><%= strTXTNameSinger %></div></td>
        </tr>
        <tr>
          <td>
            <div align="left">
              <select name="style_artist" id="style_artist">
		        <option value="<%= objrs.fields.item("style_artist").value %>" selected>
		    <% If objrs.fields.item("style_artist").value = "" Or objrs.fields.item("style_artist").value = null Then Response.Write "-- Select Style --" Else Response.Write objrs.fields.item("style_artist").value end IF %>
          ...
          <td>
            <div align="left">
              <select name="Country_artist" id="Country_artist">
		        <option value="<%= objrs.fields.item("Country_artist").value %>" selected>
		    <% If objrs.fields.item("Country_artist").value = "" Or objrs.fields.item("Country_artist").value = null Then Response.Write "-- Select Country --" Else Response.Write objrs.fields.item("Country_artist").value end IF %>
            <!-- Include countires include file -->
        ...
        <tr>
          <td>
            <div align="left">
              <input name="Pic_artist" type="text" id="Pic_artist" value="<%= objrs.fields.item("Pic_artist").value %>">
            </div></td>
		...
		<td>
		  <div align="left">
		    <textarea name="BiografY" cols="50" rows="5" wrap="VIRTUAL" id="BiografY"><%= objrs.fields.item("about_artist").value %></textarea>
		    </div></td>
        ...
        <tr>
          <td colspan="2">
              ...
              <input type="submit" name="Submit" value="<%= strTXTSend %>">
            
			&nbsp;&nbsp;
              
               <input type="reset" name="Submit" value="<%= strTXTRest %>">
