...
<table width="100%"  border="0">
  <tr>
    <td class="H1"><%= strTXTEditBanner %></td>
  </tr>
  <tr>
    <td>
<form action="code_page/Edit_banner_code.asp" method="post" name="Add_banner">
  ...
  <tr>
    <td><div align="left">
          ...
          <input name="name_banner" type="text" id="name_banner" value="<%= objRS.fields.item("name_banner").value %>">
    </div></td>
    <td class="text3"><div align="right"><%= strTXTNameBanner %></div></td>
  </tr>
  <tr>
    <td><div align="left">
      <input name="link_site_banner" type="text" id="link_site_banner" value="<%= objRS.fields.item("link_site_banner").value %>">
    </div></td>
    <td class="text3"><div align="right"><%= strTXTlinksite %></div></td>
  </tr>
  <tr>
    <td><div align="left">
      <input name="link_banner" type="text" id="link_banner" value="<%= objRS.fields.item("link_banner").value %>">
    </div></td>
    <td class="text3"><div align="right"><%= strTXTlinkBanner %></div></td>
  </tr>
  <tr>
    <td><div align="left">
      <input name="date_exp_banner" type="text" id="date_exp_banner" value="<%= objRS.fields.item("date_exp_banner").value %>">
    </div></td>
